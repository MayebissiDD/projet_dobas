...
export default function EtapePaiement({ 
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <h3 className="mb-6 text-xl font-semibold text-green-700">4. Paiement des frais de dossier</h3>
      
      {/* Montant */}
      <div className="p-6 border border-yellow-200 rounded-lg bg-gradient-to-r from-yellow-50 to-green-50">
        <div className="flex items-center justify-between">
          <div>
            <h4 className="mb-1 text-lg font-bold text-yellow-800">Montant à régler</h4>
      ...
      <div className="space-y-4">
        ...
        {errors.mode_paiement && <p className="text-sm text-red-500 animate-pulse">{errors.mode_paiement}</p>}
      </div>
      ...
      {formData.mode_paiement === "depot_physique" && (
        <div className="p-4 space-y-3 border border-blue-200 rounded-lg bg-blue-50">
          ...
          {errors.preuve_paiement && <p className="text-sm text-red-500 animate-pulse">{errors.preuve_paiement}</p>}
        </div>
      )}
      ...
      {formData.mode_paiement && (
        <div className="p-4 rounded-lg bg-gray-50">
          <h5 className="mb-2 font-medium text-gray-800">Informations de paiement</h5>
      ...
      <div className="p-4 border border-gray-200 rounded-lg bg-gray-50">
        ...
        {errors.certification && <p className="mt-2 text-sm text-red-500 animate-pulse">{errors.certification}</p>}
      </div>
      ...
      <div className="p-4 border border-green-200 rounded-lg bg-green-50">
        <h5 className="mb-2 font-medium text-green-800">Récapitulatif de votre candidature</h5>
      ...
      <div className="flex pt-4 space-x-4">
        ...
        <Button 
          ...
          className="flex-1 py-3 text-lg font-semibold text-white bg-gradient-to-r from-yellow-400 to-green-600 hover:from-yellow-500 hover:to-green-700"
        >
          {isSubmitting ? (
            <div className="flex items-center space-x-2">
      ...
      {/* Note finale */}
      <div className="mt-4 space-y-1 text-xs text-center text-gray-500">
