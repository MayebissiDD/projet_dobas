...
export default function EcolesEdit({ ecole }) {
  const { errors } = usePage().props;
  const [values, setValues] = useState({
    nom: ecole.nom || '',
    logo: ecole.logo || '',
    promoteur: ecole.promoteur || '',
    contacts: ecole.contacts || '',
  ...
  function handleSubmit(e) {
    e.preventDefault();
    Inertia.put(route('admin.ecoles.update', ecole.id), values);
  }

  return (
    <div className="container mx-auto py-8 max-w-xl">
      <h1 className="text-2xl font-bold mb-6">Modifier l'école partenaire</h1>
...
// Les composants Input et Textarea sont identiques à ceux de EcolesCreate, tu peux extraire dans un fichier commun
