...
import { Input, Textarea } from './FormComponents'; // ou comme avant

export default function BoursesEdit({ bourse }) {
  ...
  const [values, setValues] = useState({
    ...
    ecoles_eligibles: bourse.ecoles_eligibles || [],
    filieres_eligibles: bourse.filieres_eligibles || [],
    statut: bourse.statut || 'active',
  });
  ...
  function handleSubmit(e) {
    e.preventDefault();
    Inertia.put(route('admin.bourses.update', bourse.id), values);
  }

  return (
    <div className="container mx-auto py-8 max-w-xl">
      <h1 className="text-2xl font-bold mb-6 text-zinc-900 dark:text-white">Modifier la bourse</h1>
...
BoursesEdit.layout = (page) => <AdminLayout>{page}</AdminLayout>;
