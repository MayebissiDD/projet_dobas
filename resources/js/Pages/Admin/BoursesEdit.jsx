...
export default function BoursesEdit({ bourse }) {
  ...
  const [values, setValues] = useState({ ...bourse, ecoles_eligibles: bourse.ecoles_eligibles || [], filieres_eligibles: bourse.filieres_eligibles || [] });
  ...
  return (
    <div className="container mx-auto py-8 max-w-xl">
      <h1 className="text-2xl font-bold mb-6">Modifier la bourse</h1>
