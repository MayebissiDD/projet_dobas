  ...
  return (
    <div className="min-h-screen py-10 px-6 md:px-20 bg-gradient-to-br from-white via-zinc-50 to-zinc-100 dark:from-zinc-900 dark:to-zinc-800 text-zinc-900 dark:text-white">
      ...
      >
        ...
        <p className="text-muted-foreground">Alertes en temps réel sur les dossiers, paiements et candidatures.</p>
      </motion.div>
...
AgentNotifications.layout = (page) => <AgentLayout>{page}</AgentLayout>;
